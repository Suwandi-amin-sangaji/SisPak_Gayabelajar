...
<body>
    <main class="batas-atas">
        <div class="container card text-white bg-info ">
          ...
          <div class="card-body text-left ukuran-20">
            ...
            <form method="post" action="solusi.php" enctype="multipart/form-data" role="form">
                ...
                if ($row['isi_solusi']=="x-1" || $row['isi_solusi']=="x-2" || $row['isi_solusi']=="x-3" || $row['isi_solusi']=="x-4" || $row['isi_solusi']=="x-5") {
                            ...
                            <div class="card-body">
                             <form action="solusi.php" method="post">
                              <div class="form-group">
                                <label for="exampleFormControlSelect1">Pilih Gaya Belajar :</label>
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" name="fakta" class="form-control" id="exampleFormControlInput1" placeholder="...............">
                              </div>
                    ...
                    echo "<center><p>Hasil Analisis Menunjukkan Gaya Belajar Anda Adalah :</p></center>";
                    echo  "<center><p><strong style='color:black; font-size:25px;'>".$row['isi_solusi']."</stong></p></center>\n";
                }
            ...
            <div class="text-center">
                <a style="margin-bottom: 5px;" href="hapus-session.php" class="btn btn-outline-light col-sm-2">Akhiri</a>
            </div>
          </div>
